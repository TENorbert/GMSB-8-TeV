...
# with command line options: Configuration/GenProduction/python/EightTeV/GMSB_Lambda220_CTau10000_8TeV_pythia6_cff.py -s GEN,SIM --conditions=START61_V11::All --beamspot Realistic8TeVCollision --pileup 2012_Summer_50ns_PoissonOOTPU --datatier GEN-SIM --mc --eventcontent RAWSIM -n 5 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    name = cms.untracked.string('$Source: Configuration/GenProduction/python/GMSB_Lambda220_CTau10000_8TeV_pythia6_cff.py,v $')
)
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('GMSB_Lambda220_CTau10000_8TeV_pythia6_cff_py_GEN_SIM_PU.root'),
